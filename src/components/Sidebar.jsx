...
const Sidebar = (props) => {
  ...
  return (
    <div
      className={`bg-[#AFCBFF] flex flex-col items-start justify-between max-h-[90vh] z-50 absolute bottom-0 overflow-hidden box-border transition-all p-4 min-h-[90vh] ${
        props.onClick
